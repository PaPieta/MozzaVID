...
def resnet50(*, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    return _resnet(Bottleneck, [3, 4, 6, 3], None, progress, **kwargs)
...
def resnet101(*, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    return _resnet(Bottleneck, [3, 4, 23, 3], None, progress, **kwargs)
...
def resnet152(*, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    return _resnet(Bottleneck, [3, 8, 36, 3], None, progress, **kwargs)
