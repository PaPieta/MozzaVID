'''
This python file has been copied from https://github.com/xmuyzz/3D-CNN-PyTorch/tree/master/model
'''
...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=1000, sample_size=304, width_mult=1., in_channels=1):
